...
while(pos > 0):
    ...
    pos = sgt_calc(temp_traces,sgt_th,1)
    #print pos
    
    #5. IF TEMPERATURE GRADIENT EXCEEDS THRESHOLD
    if pos > 0:
        #6.     BUILD POWER TRACES BASED ON SCHEDULER TECHNIQUE
        new_power_traces = build_new_ptraces(power_traces,temp_traces,pos,1)
...
os.system('perl ' + pl_grid + ' ' + flp + ' ' + grid_file + ' 64' + ' 64' + ' 322' + ' 354' + ' > out.svg')
